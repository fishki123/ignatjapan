    ...
    <div class="flex-1 bg-gray-300 p-4 pb-24 md:pb-5">
        <div class="bg-gray-100 border-2 border-black p-4 h-full md:h-full rounded-lg shadow-lg">
            <div class="md:w-full w-auto ">
                ...
                <p class="p-16 md:p-16">Японская литература — литература на японском языке, хронологически охватывающая период почти в полтора тысячелетия: от летописи «Кодзики» (712 год) до произведений современных авторов.
                ...
                <p>Заходите и читайте, не стесняйтесь!</p>
            </div>
            <div class="md:w-full w-auto ">
            </div>
        </div>
